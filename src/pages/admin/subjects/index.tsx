...
const MOCK_SUBJECTS: Subject[] = [
  {
    ...
    name: "Mathematics",
    description:
      "The study of numbers, quantity, space, structure, and change.",
  ...
  },
  {
    ...
    name: "Literature",
    description:
      "The body of written works of a language, period, or culture, considered as having artistic merit.",
  ...
  const columns = [
    {
      ...
      cell: (subject: Subject) => (
        <span className="text-muted-foreground text-sm">{subject.id}</span>
      ),
      sortable: true,
    },
    {
    ...
    },
    {
      ...
      cell: (subject: Subject) => (
        <div className="flex justify-end">
          <DropdownMenu key={`${subject.id}-${formDrawerOpen}`}>
            ...
            <DropdownMenuContent align="end">
              ...
              <DropdownMenuItem
                onClick={(e) => {
                  e.stopPropagation();
                  handleManageCourses(subject.id);
                }}
              >
  ...
  return (
    <AdminLayout>
      ...
      <DataFormDrawer
        ...
        description={
          isEditMode ? "Update subject details" : "Create a new subject"
        }
        open={formDrawerOpen}
        onOpenChange={(open) => {
