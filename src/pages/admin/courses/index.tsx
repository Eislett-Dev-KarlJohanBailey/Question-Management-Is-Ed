...
const MOCK_COURSES: Course[] = [
  ...
  },
  {
    ...
    name: "Mechanics",
    description:
      "Study of classical mechanics, including Newton's laws, energy, and momentum.",
    subjectId: "2",
  ...
  },
  {
    ...
    name: "Shakespeare",
    description:
      "An exploration of William Shakespeare's major plays and sonnets.",
    subjectId: "3",
  ...
  },
  {
    ...
    name: "World War II",
    description:
      "A comprehensive study of the causes, events, and consequences of World War II.",
    subjectId: "4",
  ...
  const columns = [
    {
      ...
      header: "ID",
      cell: (course: Course) => (
        <span className="text-muted-foreground text-sm">{course.id}</span>
      ),
      sortable: true,
    },
    {
    ...
    },
    {
      id: "subject",
      header: "Subject",
      cell: (course: Course) => <span>{getSubjectName(course.subjectId)}</span>,
      sortable: true,
    },
    {
      id: "description",
    ...
    },
    {
      id: "createdAt",
      header: "Created At",
      cell: (course: Course) => new Date(course.createdAt).toLocaleDateString(),
      sortable: true,
    },
    {
      id: "actions",
      ...
      cell: (course: Course) => (
        <div className="flex justify-end">
          <DropdownMenu key={`${course.id}-${formDrawerOpen}`}>
  ...
  return (
    <AdminLayout>
      ...
      <DataFormDrawer
        ...
        description={
          isEditMode ? "Update course details" : "Create a new course"
        }
        open={formDrawerOpen}
        onOpenChange={(open) => {
